	...
	return (
		<nav className=" w-full fixed z-40">
			<div className={`px-4 md:px-16 py-6 flex flex-row items-center transition duration-500 ${showBackground ? 'bg-zinc-900/90' : ''}`}>
				...
				<div onClick={toggleMobileMenu} className=" lg:hidden flex flex-row items-center gap-2 ml-8 pt-1 cursor-pointer relative ">
				...
				<div className=" flex flex-row ml-auto gap-7 items-center">
					...
					<div onClick={toggleAccountMenu} className=" flex flex-row items-center gap-2 cursor-pointer relative">
						<div className=" w-6 h-6 lg:w-10 md:h-10 rounded-md overflow-hidden ">
							<img src="/images/default-red.png" alt="Profil" />
						</div>
